...
buildscript {
    ...
    dependencies {
        classpath 'kr.entree:spigradle:1.4.1'
    }
}
...
```groovy
plugins {
    id 'kr.entree.spigradle.bungee' version '1.4.1'
}
```
...
```groovy
plugins {
    id 'kr.entree.spigradle.nukkit' version '1.4.1'
}
```
...
| spigradle()       | kr.entree:spigradle:$version                     | 1.4.1       |
