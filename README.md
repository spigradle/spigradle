...
buildscript {
    ...
    dependencies {
        classpath 'kr.entree:spigradle:2.4.4'
    }
}
...
plugins {
    id 'java'
    id 'kr.entree.spigradle.bungee' version '2.4.4'
}
...
plugins {
    id 'java'
    id 'kr.entree.spigradle.nukkit' version '2.4.4'
}
...
| spigradle()       | kr.entree:spigradle:$version                     | 2.4.4       | mavenCentral()           |
