...
buildscript {
    ...
    dependencies {
        classpath 'kr.entree:spigradle:1.0.0'
    }
}
...
plugins {
    id 'java'
    id 'kr.entree.spigradle.bungee' version '1.0.0'
}
...
plugins {
    id 'java'
    id 'kr.entree.spigradle.nukkit' version '1.0.0'
}
...
| spigradle()       | kr.entree:spigradle:$version                     | 1.0.0       |
