...
buildscript {
    ...
    dependencies {
        classpath 'kr.entree:spigradle:2.2.2'
    }
}
...
plugins {
    id 'java'
    id 'kr.entree.spigradle.bungee' version '2.2.2'
}
...
plugins {
    id 'java'
    id 'kr.entree.spigradle.nukkit' version '2.2.2'
}
...
| spigradle()       | kr.entree:spigradle:$version                     | 2.2.2       |
